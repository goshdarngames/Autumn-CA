...
#define __PYX_HAVE__Conway__lib__neighbourhood
#define __PYX_HAVE_API__Conway__lib__neighbourhood
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'Conway.lib.neighbourhood' */
static PyArrayObject *__pyx_f_6Conway_3lib_13neighbourhood_moore_neighbourhood(PyArrayObject *, int, int, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t = { "uint8_t", NULL, sizeof(__pyx_t_5numpy_uint8_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_uint8_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_uint8_t), 0 };
#define __Pyx_MODULE_NAME "Conway.lib.neighbourhood"
extern int __pyx_module_is_main_Conway__lib__neighbourhood;
int __pyx_module_is_main_Conway__lib__neighbourhood = 0;

/* Implementation of 'Conway.lib.neighbourhood' */
...
static PyObject *__pyx_pf_6Conway_3lib_13neighbourhood_moore_neighbourhood(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_np_2d_array, int __pyx_v_x, int __pyx_v_y, PyArrayObject *__pyx_v_n_out); /* proto */
...
/* "Conway/lib/neighbourhood.pyx":6
 * 
 * 
...
static PyObject *__pyx_pw_6Conway_3lib_13neighbourhood_1moore_neighbourhood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_6Conway_3lib_13neighbourhood_moore_neighbourhood(PyArrayObject *__pyx_v_np_2d_array, int __pyx_v_x, int __pyx_v_y, PyArrayObject *__pyx_v_n_out, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_width;
  int __pyx_v_height;
  int __pyx_v_n_x;
  int __pyx_v_n_y;
  ...
  /* "Conway/lib/neighbourhood.pyx":13
 * 
 * 
 ...
 */
  ...
  /* "Conway/lib/neighbourhood.pyx":14
 * 
 *     cdef int width = np_2d_array.shape[0]
 *     cdef int height = np_2d_array.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "Conway/lib/neighbourhood.pyx":16
 *     cdef int height = np_2d_array.shape[1]
 * 
 *     cdef int n_x, n_y = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "Conway/lib/neighbourhood.pyx":18
 *     cdef int n_x, n_y = 0
 * 
 *     cdef int i,j = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "Conway/lib/neighbourhood.pyx":20
 *     cdef int i,j = 0
 * 
 *     cdef int count = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "Conway/lib/neighbourhood.pyx":23
 * 
 *     #loop through -1 to 0
 *     for i in range ( 3 ):             # <<<<<<<<<<<<<<
 *         for j in range ( 3 ):
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "Conway/lib/neighbourhood.pyx":24
 *     #loop through -1 to 0
 *     for i in range ( 3 ):
 *         for j in range ( 3 ):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    for (__pyx_t_2 = 0; __pyx_t_2 < 3; __pyx_t_2+=1) {
      ...
      /* "Conway/lib/neighbourhood.pyx":26
 *         for j in range ( 3 ):
 * 
 *             n_x = ( width + x + i - 1 ) % width             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "Conway/lib/neighbourhood.pyx":27
 * 
 *             n_x = ( width + x + i - 1 ) % width
 *             n_y = ( height + y + j - 1 ) % height             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "Conway/lib/neighbourhood.pyx":32
 *             #n_y = (y + j-1) % height
 * 
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_n_out.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_n_out.diminfo[0].strides) = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_np_2d_array.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_np_2d_array.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_np_2d_array.diminfo[1].strides));
      ...
      /* "Conway/lib/neighbourhood.pyx":33
 * 
 *             n_out [ count ] =  np_2d_array [n_x, n_y]
 *             count+=1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("Conway.lib.neighbourhood.moore_neighbourhood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_n_out.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_6Conway_3lib_13neighbourhood_1moore_neighbourhood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6Conway_3lib_13neighbourhood_1moore_neighbourhood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_6Conway_3lib_13neighbourhood_moore_neighbourhood(__pyx_self, __pyx_v_np_2d_array, __pyx_v_x, __pyx_v_y, __pyx_v_n_out);
...
static PyObject *__pyx_pf_6Conway_3lib_13neighbourhood_moore_neighbourhood(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_np_2d_array, int __pyx_v_x, int __pyx_v_y, PyArrayObject *__pyx_v_n_out) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_n_out;
  __Pyx_Buffer __pyx_pybuffer_n_out;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_np_2d_array;
  __Pyx_Buffer __pyx_pybuffer_np_2d_array;
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_6Conway_3lib_13neighbourhood_moore_neighbourhood(__pyx_v_np_2d_array, __pyx_v_x, __pyx_v_y, __pyx_v_n_out, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"moore_neighbourhood", (PyCFunction)__pyx_pw_6Conway_3lib_13neighbourhood_1moore_neighbourhood, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_Conway__lib__neighbourhood) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Conway.lib.neighbourhood")) {
      if (unlikely(PyDict_SetItemString(modules, "Conway.lib.neighbourhood", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "Conway/lib/neighbourhood.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Conway.lib.neighbourhood", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Conway.lib.neighbourhood");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
